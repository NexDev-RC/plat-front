...
export function AdminDashboard({ initialUsers, initialCourses, usersTotal, coursesTotal }: Props) {
  ...
  const drafts      = initialCourses.filter((c) => !c.isPublished).length

  const STATS = [
    { label: 'Usuarios',          value: usersTotal,   icon: Users,         color: 'bg-blue-100   text-blue-600   dark:bg-blue-900   dark:text-blue-300'   },
  ...
  return (
    <div className="container-page section-padding">
      ...
      <div className="mb-6 flex items-center justify-between border-b border-gray-200 dark:border-gray-800">
        ...
        {/* Acción principal según tab activo */}
        {activeTab === 'courses' && (
...
// Botón que abre el modal de crear usuario (definido aquí para mantener el estado en el mismo árbol)
function CreateUserButton() {
  // Importamos dinámicamente para evitar ciclo; usamos un evento custom
  return (
    <button
