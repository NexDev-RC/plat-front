...
export default async function InstructorCoursesPage() {
  ...
  let courses: Course[] = []
  try {
    courses = await serverGet<Course[]>('/courses/manage/my')
  } catch {
    redirect('/dashboard')
  }
    ...
    <div className="container-page section-padding">
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-gray-500">Gestiona tus cursos publicados y borradores</p>
        </div>
      ...
      {courses.length === 0 ? (
        <div className="flex flex-col items-center rounded-2xl border border-dashed border-gray-300 py-20 text-center dark:border-gray-700">
          ...
          <Link href="/instructor/courses/new"
            className="mt-5 flex items-center gap-2 rounded-lg bg-primary-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-700">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-xs text-gray-500">{course.totalLessons ?? 0} lecciones</p>
                      </div>
                    </div>
                  </td>
